...
public class InventoryStashServlet extends HttpServlet
{
	...
	public void doPostGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try {
			String json = sess.selectOne(
				"gov.alaska.dggs.igneous.Inventory.getStashByID", id
			);
