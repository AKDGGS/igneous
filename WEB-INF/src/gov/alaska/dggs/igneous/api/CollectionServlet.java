...
import gov.alaska.dggs.igneous.model.Collection;
...
public class CollectionServlet extends HttpServlet
{
	...
	static {
		...
		serializer.exclude("organization.class");
		serializer.exclude("current");
	...
	public void doPostGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try {
			List<Collection> collections = sess.selectList(
				"gov.alaska.dggs.igneous.Collection.getList"
			);
			...
			try {
				...
				serializer.serialize(collections, out);
